...
const CONFIG = {
    ...
    PROXIO_BLOG_TITLE: '在地經營，不只是方便，更是可靠',
    PROXIO_BLOG_COUNT: 4, // 首页博文区块展示前4篇文章
    PROXIO_BLOG_TEXT_1: '關於我們',
    ...
    PROXIO_FEATURE_BUTTON_TEXT: '加入LINE好友領取現金折抵', // 按钮文字
    PROXIO_FEATURE_BUTTON_URL: 'https://lin.ee/OAlo5ku', // 按钮跳转
    ...
    PROXIO_CAREERS: [
        ...
        { title: '草衙店取得 Apple 原廠授權', bio: '2022', text: '草衙店正式成為 Apple IRP（獨立維修提供者）授權中心，代表我們的技術與流程通過蘋果標準，能提供原廠級維修體驗。' },
        { title: '五甲店開幕', bio: '2023', text: '拓點五甲區，提升服務範圍與可近性，也開始導入更完整的維修接待流程，提升顧客體驗與效率。' }
        { title: '小港店開幕｜旗艦擴張', bio: '2025', text: '小港店成立，主打快速完修、延長保固活動，正式從專業維修走向品牌經營，打造屬於高雄的本地連鎖維修品牌。' }
    ],
